...
void em_init();
void em_tick();
int em_register_entity(struct entity *(*create)(), void (*b)(struct map *, struct entity *, float *, float *), void(*d)(struct entity *), char i);
...
enum EM_ATTRIBUTES {ITEM = 1, HOLDABLE = 2, CANHOLD = 4, CIRCULARHITBOX = 8, CALLONCOLLIDE = 16, KILLONNEGATIVEHEALTH = 32};
