...
enum DT_DUNGEONTILES {DT_FLOOR, DT_LEFTWALL, DT_RIGHTWALL, DT_TOPWALL, DT_BOTTOMWALL, DT_WALL, DT_ERROR};
static const char *DT_NAMES[] = {"floor", "leftwall", "rightwall", "topwall", "bottomwall", "wall"};
static const char DT_TILETYPE[] = {0, SOLID, SOLID, SOLID, SOLID, SOLID, 0};
